        ...
        <Container>
          <div className='flex justify-between w-full'>
            <div className='flex flex-col gap-3 w-1/4'>
              <div className='text-[hsl(0,7%,94%)] font-bold text-[16px] lg:text-[32px] flex gap-2'>      <ReactSVG src='/assets/logo.svg' className='h-6 w-6 py-2' /><span>TripPix</span></div>
            ...
            <div className='flex flex-col gap-7 w-1/4 mb-40'>
        ...
        <Container>
          <div className='flex justify-between flex-col w-full'>
            <div className='flex flex-col gap-3 w-full'>
              ...
              <h3 className='text-gray-400'>Embark on a hassle-free journey through our intuitive travel website. Your dream adventure awaits, just a click away.</h3>
