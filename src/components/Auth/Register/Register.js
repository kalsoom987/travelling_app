            ...
            <Container>
                <div className='flex flex-col items-center w-full'>
                    ...
                    <div className='flex w-full items-center justify-center'>
                        ...
                        <div
                            className={`w-[100px] h-[2px] ${step > 1 ? 'bg-[#6553F7]' : 'bg-[#d9d9d9]'
                                } duration-300 transition-all`}></div>
                        <p
                            className={`w-10 h-10 ${step > 1 ? 'bg-[#6553F7]' : 'bg-[#d9d9d9]'
                                } duration-300 transition-all  text-white flex justify-center items-center font-semibold rounded-full`}>
                            2
                        </p>
                        <div
                            className={`w-[100px] h-[2px] ${step > 2 ? 'bg-[#6553F7]' : 'bg-[#d9d9d9]'
                                } duration-300 transition-all`}></div>
                        <p
                            className={`w-10 h-10 ${step > 2 ? 'bg-[#6553F7]' : 'bg-[#d9d9d9]'
                    ...
                    <div className='w-full flex justify-between items-center'>
                        <button
                            ...
                            className={` ${step > 1 ? 'opacity-1 hover:bg-[#6553F7] hover:text-white' : 'opacity-[0.3] cursor-not-allowed'
